...
//                         map['message'] = "Your Deficit Account With Email: $email Has Been Updated \n Your Account is Registered with Email: ${emailController.text}";
//                         map['email'] = email;
//                         map['password'] = pass;
//                         map['goal'] = {};
//                         map['logs'] = [];
...
//                       height: 30.0,
//                       color: kPrimaryColor,
//                       child: const Center(child: Text('Delete User')),
//                     ),
//                     onPressed: () async {
//                       if (passController.text == confirmPassController.text) {
//                         String email = emailController.text;
...
//                         map['firstName'] = fNameController.text;
//                         map['lastName'] = lNameController.text;
//                         map['message'] = "Your Deficit Account With Email: $email Has Been Deleted";
//                         map['email'] = email;
//                         map['password'] = pass;
//                         map['goal'] = {};
//                         map['logs'] = [];
...
//                           print(request);
//                         }
//                         final response = await delete(kDomain, 'user', json.encode(request));
//                         final response3 = await post(kDomain, 'email', json.encode(request));
